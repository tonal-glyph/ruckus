...
pub mod root {
    ...
    pub struct timex {
        ...
        pub _bitfield_1:
            crate::core::util::thread::thread::root::__BindgenBitfieldUnit<[u8; 44usize], u8>,
    }
    #[test]
    ...
    impl timex {
        ...
        {
            let mut __bindgen_bitfield_unit: crate::core::util::thread::thread::root::__BindgenBitfieldUnit<[u8; 44usize], u8> =
                Default::default();
