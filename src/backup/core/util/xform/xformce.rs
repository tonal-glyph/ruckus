...
pub mod root {
    ...
    extern "C" {
        pub fn hanning(window: *mut f64, length: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn hamming(window: *mut f64, length: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn blackman(window: *mut f64, length: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn bartlett(window: *mut f64, length: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn apply_window(data: *mut f64, window: *mut f64, length: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn rfft(x: *mut f64, N: ::std::os::raw::c_long, forward: ::std::os::raw::c_uint);
    }
    extern "C" {
        pub fn cfft(x: *mut f64, NC: ::std::os::raw::c_long, forward: ::std::os::raw::c_uint);
    }
    extern "C" {
        pub fn the_dct(
            x: *mut f64,
    ...
    extern "C" {
        pub fn the_dct_matrix(out: *mut *mut f64, N: ::std::os::raw::c_ulong);
    }
    extern "C" {
    ...
    extern "C" {
        pub fn the_inverse_dct_matrix(out: *mut *mut f64, N: ::std::os::raw::c_ulong);
    }
    extern "C" {
        pub fn the_dct_now(
            x: *mut f64,
    ...
    extern "C" {
        pub static mut PI: f32;
    }
    extern "C" {
        pub static mut TWOPI: f32;
    }
    extern "C" {
        pub fn bit_reverse(x: *mut f64, N: ::std::os::raw::c_long);
    }
}
