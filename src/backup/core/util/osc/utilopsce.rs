...
pub mod root {
    ...
    #[test]
    fn bindgen_test_layout_OSCTimeTag() {
        assert_eq!(
            ::std::mem::size_of::<OSCTimeTag>(),
            8usize,
            concat!("Size of: ", stringify!(OSCTimeTag))
        );
        assert_eq!(
            ::std::mem::align_of::<OSCTimeTag>(),
            4usize,
            concat!("Alignment of ", stringify!(OSCTimeTag))
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCTimeTag>())).seconds as *const _ as usize },
            0usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCTimeTag),
                "::",
                stringify!(seconds)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCTimeTag>())).fraction as *const _ as usize },
            4usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCTimeTag),
    ...
    #[test]
    fn bindgen_test_layout_OSCbuf_struct() {
        assert_eq!(
            ::std::mem::size_of::<OSCbuf_struct>(),
            320usize,
            concat!("Size of: ", stringify!(OSCbuf_struct))
        );
        assert_eq!(
            ::std::mem::align_of::<OSCbuf_struct>(),
            8usize,
            concat!("Alignment of ", stringify!(OSCbuf_struct))
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).buffer as *const _ as usize },
            0usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
                "::",
                stringify!(buffer)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).size as *const _ as usize },
            8usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).bufptr as *const _ as usize },
            16usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).state as *const _ as usize },
            24usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).thisMsgSize as *const _ as usize },
            32usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
                "::",
                stringify!(thisMsgSize)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).prevCounts as *const _ as usize },
            40usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
                "::",
                stringify!(prevCounts)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).bundleDepth as *const _ as usize },
            296usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
                "::",
                stringify!(bundleDepth)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<OSCbuf_struct>())).typeStringPtr as *const _ as usize },
            304usize,
            concat!(
                "Offset of field: ",
                stringify!(OSCbuf_struct),
                "::",
                stringify!(typeStringPtr)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<OSCbuf_struct>())).gettingFirstUntypedArg as *const _
                    as usize
            },
            312usize,
            concat!(
                ...
                stringify!(OSCbuf_struct),
                "::",
                stringify!(gettingFirstUntypedArg)
            )
        );
    }
    impl Default for OSCbuf_struct {
        fn default() -> Self {
            unsafe { ::std::mem::zeroed() }
        }
    }
