...
pub mod root {
    ...
    pub const ONE_MSG_ARGS: u32 = 1;
    pub const NEED_COUNT: u32 = 2;
    pub const GET_ARGS: u32 = 3;
    pub const DONE: u32 = 4;
    pub const STRING_ALIGN_PAD: u32 = 4;
    pub mod std {
        ...
        impl<_IntType> Default for uniform_int_distribution_param_type<_IntType> {
            fn default() -> Self {
                unsafe { ::std::mem::zeroed() }
            }
        }
        impl<_IntType> Default for uniform_int_distribution<_IntType> {
            fn default() -> Self {
                unsafe { ::std::mem::zeroed() }
            }
        }
        pub const std__S_threshold: root::std::_bindgen_ty_2 = 16;
        pub type _bindgen_ty_2 = u32;
        pub const std__S_chunk_size: root::std::_bindgen_ty_3 = 7;
