...
pub mod root {
    ...
    pub const MSG_TRYHARD: _bindgen_ty_1 = _bindgen_ty_1::MSG_DONTROUTE;
    ...
    pub struct cmsghdr {
        ...
        pub __cmsg_data:
            crate::core::otf::otf::root::__IncompleteArrayField<::std::os::raw::c_uchar>,
    }
    #[test]
    ...
    pub const SCM_CREDENTIALS: _bindgen_ty_2 = _bindgen_ty_2::SCM_CREDENTIALS;
    #[repr(u32)]
    #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord)]
    ...
    extern "C" {
        #[link_name = "\u{1}clear"]
        pub fn Net_Msg_clear(this: *mut Net_Msg);
    }
    extern "C" {
        #[link_name = "\u{1}Net_Msg"]
        pub fn Net_Msg_Net_Msg(this: *mut Net_Msg);
    }
