...
pub mod root {
    ...
    pub mod std {
        ...
        pub mod __cxx11 {
            ...
            pub struct basic_string__bindgen_ty_2<_CharT> {
                pub _M_local_buf: crate::core::stats::stats::root::__BindgenUnionField<*mut _CharT>,
                pub _M_allocated_capacity:
                    crate::core::stats::stats::root::__BindgenUnionField<basic_string_size_type>,
    ...
    pub struct timex {
        ...
        pub _bitfield_1: crate::core::stats::stats::root::__BindgenBitfieldUnit<[u8; 44usize], u8>,
    }
    #[test]
    ...
    impl timex {
        ...
        ) -> crate::core::stats::stats::root::__BindgenBitfieldUnit<[u8; 44usize], u8> {
            let mut __bindgen_bitfield_unit: crate::core::stats::stats::root::__BindgenBitfieldUnit<[u8; 44usize], u8> =
                Default::default();
    ...
    pub const _ISupper: _bindgen_ty_49 = _bindgen_ty_49::_ISupper;
    pub const _ISlower: _bindgen_ty_49 = _bindgen_ty_49::_ISlower;
    pub const _ISalpha: _bindgen_ty_49 = _bindgen_ty_49::_ISalpha;
    pub const _ISdigit: _bindgen_ty_49 = _bindgen_ty_49::_ISdigit;
    pub const _ISxdigit: _bindgen_ty_49 = _bindgen_ty_49::_ISxdigit;
    pub const _ISspace: _bindgen_ty_49 = _bindgen_ty_49::_ISspace;
    pub const _ISprint: _bindgen_ty_49 = _bindgen_ty_49::_ISprint;
    pub const _ISgraph: _bindgen_ty_49 = _bindgen_ty_49::_ISgraph;
    pub const _ISblank: _bindgen_ty_49 = _bindgen_ty_49::_ISblank;
    pub const _IScntrl: _bindgen_ty_49 = _bindgen_ty_49::_IScntrl;
    pub const _ISpunct: _bindgen_ty_49 = _bindgen_ty_49::_ISpunct;
    pub const _ISalnum: _bindgen_ty_49 = _bindgen_ty_49::_ISalnum;
    #[repr(u32)]
    #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord)]
    ...
    fn __bindgen_test_layout_pair_open0_const_unsigned_long_ptr_Shred_Stat_close0_instantiation() {
        assert_eq!(
            ::std::mem::size_of::<pair<::std::os::raw::c_ulong, *mut Shred_Stat>>(),
            16usize,
            concat!(
                "Size of template specialization: ",
                stringify ! ( pair < :: std :: os :: raw :: c_ulong , * mut Shred_Stat > )
            )
        );
        assert_eq!(
            ::std::mem::align_of::<pair<::std::os::raw::c_ulong, *mut Shred_Stat>>(),
            8usize,
            concat!(
                "Alignment of template specialization: ",
                stringify ! ( pair < :: std :: os :: raw :: c_ulong , * mut Shred_Stat > )
