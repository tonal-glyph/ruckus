...
impl Chuck_Event {
    ...
    #[inline]
    pub unsafe fn remove(&mut self, shred: *mut root::Chuck_VM_Shred) -> ::std::os::raw::c_ulong {
...
extern "C" {
    ...
    pub fn Chuck_IO_File_writeStr_thread(data: *mut ::std::os::raw::c_void) -> root::THREAD_RETURN;
}
extern "C" {
    #[link_name = "\u{1}writeInt_thread"]
    pub fn Chuck_IO_File_writeInt_thread(data: *mut ::std::os::raw::c_void) -> root::THREAD_RETURN;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_IO_File_readLine(this: *mut ::std::os::raw::c_void) -> *mut root::Chuck_String;
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}readLine"]
    pub fn Chuck_IO_Chout_readLine(this: *mut ::std::os::raw::c_void) -> *mut root::Chuck_String;
}
extern "C" {
    #[link_name = "\u{1}readInt"]
...
extern "C" {
    #[link_name = "\u{1}readLine"]
    pub fn Chuck_IO_Cherr_readLine(this: *mut ::std::os::raw::c_void) -> *mut root::Chuck_String;
}
extern "C" {
    #[link_name = "\u{1}readInt"]
...
pub const te_Type_te_none: root::te_Type = 0;
pub const te_Type_te_int: root::te_Type = 1;
pub const te_Type_te_uint: root::te_Type = 2;
pub const te_Type_te_single: root::te_Type = 3;
pub const te_Type_te_float: root::te_Type = 4;
pub const te_Type_te_double: root::te_Type = 5;
pub const te_Type_te_time: root::te_Type = 6;
pub const te_Type_te_dur: root::te_Type = 7;
pub const te_Type_te_complex: root::te_Type = 8;
pub const te_Type_te_polar: root::te_Type = 9;
pub const te_Type_te_string: root::te_Type = 10;
pub const te_Type_te_thread: root::te_Type = 11;
pub const te_Type_te_shred: root::te_Type = 12;
pub const te_Type_te_class: root::te_Type = 13;
pub const te_Type_te_function: root::te_Type = 14;
pub const te_Type_te_object: root::te_Type = 15;
pub const te_Type_te_user: root::te_Type = 16;
pub const te_Type_te_array: root::te_Type = 17;
pub const te_Type_te_null: root::te_Type = 18;
pub const te_Type_te_ugen: root::te_Type = 19;
pub const te_Type_te_uana: root::te_Type = 20;
pub const te_Type_te_event: root::te_Type = 21;
pub const te_Type_te_void: root::te_Type = 22;
pub const te_Type_te_stdout: root::te_Type = 23;
pub const te_Type_te_stderr: root::te_Type = 24;
pub const te_Type_te_adc: root::te_Type = 25;
pub const te_Type_te_dac: root::te_Type = 26;
pub const te_Type_te_bunghole: root::te_Type = 27;
pub const te_Type_te_uanablob: root::te_Type = 28;
pub const te_Type_te_io: root::te_Type = 29;
pub const te_Type_te_fileio: root::te_Type = 30;
pub const te_Type_te_chout: root::te_Type = 31;
pub const te_Type_te_cherr: root::te_Type = 32;
pub const te_Type_te_multi: root::te_Type = 33;
pub const te_Type_te_vec3: root::te_Type = 34;
pub const te_Type_te_vec4: root::te_Type = 35;
pub const te_Type_te_vector: root::te_Type = 36;
...
extern "C" {
    ...
    pub fn Chuck_Namespace_get_types(this: *mut root::Chuck_Namespace, out: *mut root::std::vector);
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_Namespace_get_funcs(this: *mut root::Chuck_Namespace, out: *mut root::std::vector);
}
...
pub const Chuck_Context_P_NONE: root::Chuck_Context__bindgen_ty_1 = 0;
pub const Chuck_Context_P_CLASSES_ONLY: root::Chuck_Context__bindgen_ty_1 = 1;
pub const Chuck_Context_P_ALL: root::Chuck_Context__bindgen_ty_1 = 2;
...
extern "C" {
    ...
    pub fn Chuck_Context_new_Chuck_Func(this: *mut root::Chuck_Context) -> *mut root::Chuck_Func;
}
extern "C" {
...
impl Chuck_Context {
    ...
    #[inline]
    pub unsafe fn new_Chuck_Type(&mut self, env: *mut root::Chuck_Env) -> *mut root::Chuck_Type {
...
extern "C" {
    ...
    pub fn Chuck_UGen_get_num_src(this: *mut root::Chuck_UGen) -> ::std::os::raw::c_ulong;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_UGen_system_tick(this: *mut root::Chuck_UGen, now: f64)
        -> ::std::os::raw::c_ulong;
}
extern "C" {
...
impl Chuck_UGen {
    ...
    #[inline]
    pub unsafe fn remove(&mut self, src: *mut root::Chuck_UGen) -> ::std::os::raw::c_ulong {
    ...
    #[inline]
    pub unsafe fn src_chan(&mut self, chan: ::std::os::raw::c_ulong) -> *mut root::Chuck_UGen {
...
extern "C" {
    ...
    pub fn Chuck_UAna_system_tock(this: *mut root::Chuck_UAna, now: f64)
        -> ::std::os::raw::c_ulong;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_UAna_numIncomingUAnae(this: *const root::Chuck_UAna) -> ::std::os::raw::c_long;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_UAna_blobProxy(this: *const root::Chuck_UAna) -> *mut root::Chuck_UAnaBlobProxy;
}
extern "C" {
...
impl Chuck_UAna {
    ...
    #[inline]
    pub unsafe fn getIncomingUAna(&self, index: ::std::os::raw::c_ulong) -> *mut root::Chuck_UAna {
...
extern "C" {
    ...
    pub fn FastCircularBuffer_FastCircularBuffer_destructor(this: *mut root::FastCircularBuffer);
}
...
pub struct Shred_Stat {
    ...
    pub shred_ref: *mut root::Chuck_VM_Shred,
    ...
    pub free_time: f64,
    pub name: root::std::__cxx11::string,
    pub owner: root::std::__cxx11::string,
    pub source: root::std::__cxx11::string,
    pub diffs: root::std::queue<root::std::deque>,
    pub num_diffs: ::std::os::raw::c_ulong,
    pub diff_total: f64,
    pub act_cycles: root::std::queue<root::std::deque>,
    pub act_cycles_total: ::std::os::raw::c_ulong,
    pub last_cycles: ::std::os::raw::c_ulong,
    pub children: root::std::vector,
    pub activationss: root::std::vector,
    pub mutex: root::XMutex,
    pub data: *mut root::Shred_Data,
    pub time: *mut root::Shred_Time,
}
extern "C" {
    #[link_name = "\u{1}get_sporked"]
    pub fn Shred_Stat_get_sporked(this: *mut root::Shred_Stat, out: *mut root::std::vector);
}
extern "C" {
    #[link_name = "\u{1}get_activations"]
    pub fn Shred_Stat_get_activations(this: *mut root::Shred_Stat, out: *mut root::std::vector);
}
...
impl Shred_Stat {
    #[inline]
    pub unsafe fn get_sporked(&mut self, out: *mut root::std::vector) {
        Shred_Stat_get_sporked(self, out)
    }
    #[inline]
    pub unsafe fn get_activations(&mut self, out: *mut root::std::vector) {
...
extern "C" {
    #[link_name = "\u{1}shutdown"]
    pub fn Chuck_VM_Stack_shutdown(this: *mut root::Chuck_VM_Stack) -> ::std::os::raw::c_ulong;
}
extern "C" {
...
pub const Chuck_VM_Code_NATIVE_UNKNOWN: root::Chuck_VM_Code__bindgen_ty_1 = 0;
pub const Chuck_VM_Code_NATIVE_CTOR: root::Chuck_VM_Code__bindgen_ty_1 = 1;
pub const Chuck_VM_Code_NATIVE_DTOR: root::Chuck_VM_Code__bindgen_ty_1 = 2;
pub const Chuck_VM_Code_NATIVE_MFUN: root::Chuck_VM_Code__bindgen_ty_1 = 3;
pub const Chuck_VM_Code_NATIVE_SFUN: root::Chuck_VM_Code__bindgen_ty_1 = 4;
...
extern "C" {
    #[link_name = "\u{1}shutdown"]
    pub fn Chuck_VM_Shred_shutdown(this: *mut root::Chuck_VM_Shred) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}run"]
...
impl Chuck_VM_Shred {
    ...
    #[inline]
    pub unsafe fn run(&mut self, vm: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong {
        Chuck_VM_Shred_run(self, vm)
    }
    #[inline]
    pub unsafe fn add(&mut self, ugen: *mut root::Chuck_UGen) -> ::std::os::raw::c_ulong {
        Chuck_VM_Shred_add(self, ugen)
    }
    #[inline]
    pub unsafe fn remove(&mut self, ugen: *mut root::Chuck_UGen) -> ::std::os::raw::c_ulong {
...
extern "C" {
    #[link_name = "\u{1}get"]
    pub fn Chuck_VM_Shreduler_get(this: *mut root::Chuck_VM_Shreduler)
        -> *mut root::Chuck_VM_Shred;
}
extern "C" {
    #[link_name = "\u{1}advance"]
    pub fn Chuck_VM_Shreduler_advance(
        this: *mut root::Chuck_VM_Shreduler,
        N: ::std::os::raw::c_long,
    );
}
...
extern "C" {
    ...
    pub fn Chuck_VM_Shreduler_highest(
        this: *mut root::Chuck_VM_Shreduler,
    ) -> ::std::os::raw::c_ulong;
}
extern "C" {
...
impl Chuck_VM_Shreduler {
    ...
    #[inline]
    pub unsafe fn shredule(&mut self, shred: *mut root::Chuck_VM_Shred) -> ::std::os::raw::c_ulong {
    ...
    #[inline]
    pub unsafe fn lookup(&mut self, xid: ::std::os::raw::c_ulong) -> *mut root::Chuck_VM_Shred {
...
extern "C" {
    ...
    pub fn Chuck_VM_Shreduler_Chuck_VM_Shreduler_destructor(this: *mut root::Chuck_VM_Shreduler);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const Chuck_Global_Request_Type_set_global_int_request: root::Chuck_Global_Request_Type = 0;
pub const Chuck_Global_Request_Type_get_global_int_request: root::Chuck_Global_Request_Type = 1;
pub const Chuck_Global_Request_Type_set_global_float_request: root::Chuck_Global_Request_Type = 2;
pub const Chuck_Global_Request_Type_get_global_float_request: root::Chuck_Global_Request_Type = 3;
pub const Chuck_Global_Request_Type_signal_global_event_request: root::Chuck_Global_Request_Type =
    4;
pub const Chuck_Global_Request_Type_spork_shred_request: root::Chuck_Global_Request_Type = 5;
...
extern "C" {
    ...
    pub fn Chuck_VM_initialize_synthesis(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}shutdown"]
    pub fn Chuck_VM_shutdown(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}start"]
    pub fn Chuck_VM_start(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}running"]
    pub fn Chuck_VM_running(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}stop"]
    pub fn Chuck_VM_stop(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}spork"]
...
extern "C" {
    ...
    pub fn Chuck_VM_next_id(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}srate"]
    pub fn Chuck_VM_srate(this: *const root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}run"]
    pub fn Chuck_VM_run(
...
extern "C" {
    ...
    pub fn Chuck_VM_compute(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}abort_current_shred"]
    pub fn Chuck_VM_abort_current_shred(this: *mut root::Chuck_VM) -> ::std::os::raw::c_ulong;
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}gc"]
    pub fn Chuck_VM_gc1(this: *mut root::Chuck_VM, amount: ::std::os::raw::c_ulong);
}
extern "C" {
...
extern "C" {
    ...
    pub fn Chuck_VM_get_global_int(
        ...
        callback: ::std::option::Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_long)>,
    ) -> ::std::os::raw::c_ulong;
}
extern "C" {
...
impl Chuck_VM {
    ...
    #[inline]
    pub unsafe fn process_msg(&mut self, msg: *mut root::Chuck_Msg) -> ::std::os::raw::c_ulong {
    ...
    #[inline]
    pub unsafe fn get_ptr_to_global_float(&mut self, name: root::std::__cxx11::string) -> *mut f64 {
    ...
    #[inline]
    pub unsafe fn spork1(&mut self, shred: *mut root::Chuck_VM_Shred) -> *mut root::Chuck_VM_Shred {
...
#[repr(C)]
pub struct ChucK__bindgen_vtable(::std::os::raw::c_void);
#[repr(C)]
pub struct ChucK {
...
extern "C" {
    ...
    pub static mut ChucK_o_isGlobalInit: ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}enableSystemCall"]
    pub static mut ChucK_enableSystemCall: ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}VERSION"]
    pub static mut ChucK_VERSION: [::std::os::raw::c_char; 0usize];
}
extern "C" {
    #[link_name = "\u{1}o_numVMs"]
    pub static mut ChucK_o_numVMs: ::std::os::raw::c_ulong;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ChucK_globalInit() -> ::std::os::raw::c_ulong;
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}version"]
    pub fn ChucK_version() -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[link_name = "\u{1}intSize"]
    pub fn ChucK_intSize() -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}poop"]
    pub fn ChucK_poop();
...
extern "C" {
    ...
    pub fn ChucK_setLogLevel(level: ::std::os::raw::c_long);
}
extern "C" {
    #[link_name = "\u{1}getLogLevel"]
    pub fn ChucK_getLogLevel() -> ::std::os::raw::c_long;
}
extern "C" {
...
impl ChucK {
    ...
    #[inline]
    pub unsafe fn signalGlobalEvent(
        &mut self,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_ulong {
    ...
    #[inline]
    pub unsafe fn broadcastGlobalEvent(
        &mut self,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_ulong {
    ...
    #[inline]
    pub unsafe fn globalInit() -> ::std::os::raw::c_ulong {
        ChucK_globalInit()
    }
    #[inline]
    ...
    #[inline]
    pub unsafe fn intSize() -> ::std::os::raw::c_ulong {
        ChucK_intSize()
    }
    #[inline]
    pub unsafe fn poop() {
    ...
    #[inline]
    pub unsafe fn setLogLevel(level: ::std::os::raw::c_long) {
        ChucK_setLogLevel(level)
    }
    #[inline]
    pub unsafe fn getLogLevel() -> ::std::os::raw::c_long {
        ChucK_getLogLevel()
    }
    #[inline]
