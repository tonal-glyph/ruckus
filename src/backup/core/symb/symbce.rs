...
pub struct S_Symbol_ {
    pub name: root::c_str,
    pub next: root::S_Symbol,
}
// #[test]
// fn bindgen_test_layout_S_Symbol_() {
//     assert_eq!(
//         ::std::mem::size_of::<S_Symbol_>(),
//         16usize,
//         concat!("Size of: ", stringify!(S_Symbol_))
//     );
//     assert_eq!(
//         ::std::mem::align_of::<S_Symbol_>(),
//         8usize,
//         concat!("Alignment of ", stringify!(S_Symbol_))
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<S_Symbol_>())).name as *const _ as usize },
//         0usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(S_Symbol_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<S_Symbol_>())).next as *const _ as usize },
//         8usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(S_Symbol_),
...
//     );
// }
impl Default for S_Symbol_ {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    pub static mut hashtable: [self::S_Symbol; 65347usize];
}
extern "C" {
    pub static mut marksym: root::S_Symbol_;
}
extern "C" {
    pub fn S_dump(
        t: root::S_table,
        show: ::std::option::Option<
            unsafe extern "C" fn(sym: root::S_Symbol, binding: *mut ::std::os::raw::c_void),
        >,
    );
}
