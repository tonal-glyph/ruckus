...
pub mod root {
    ...
    pub mod std {
        ...
        pub mod __cxx11 {
            ...
            pub struct basic_string__bindgen_ty_2<_CharT> {
                pub _M_local_buf:
                    crate::core::compile::compilec::root::__BindgenUnionField<*mut _CharT>,
                pub _M_allocated_capacity:
                    crate::core::compile::compilec::root::__BindgenUnionField<
    ...
    #[repr(C)]
    pub struct Chuck_UAnaBlobProxy__bindgen_vtable(::std::os::raw::c_void);
    #[repr(C)]
    #[derive(Debug, Hash, PartialOrd, Ord, PartialEq, Eq)]
    ...
    #[test]
    fn bindgen_test_layout_Chuck_UAnaBlobProxy() {
        assert_eq!(
            ::std::mem::size_of::<Chuck_UAnaBlobProxy>(),
            16usize,
            concat!("Size of: ", stringify!(Chuck_UAnaBlobProxy))
        );
        assert_eq!(
            ::std::mem::align_of::<Chuck_UAnaBlobProxy>(),
            8usize,
            concat!("Alignment of ", stringify!(Chuck_UAnaBlobProxy))
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_UAnaBlobProxy>())).m_blob as *const _ as usize },
            8usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_UAnaBlobProxy),
                "::",
                stringify!(m_blob)
            )
        );
    ...
    impl Default for Chuck_UAnaBlobProxy {
        fn default() -> Self {
            unsafe { ::std::mem::zeroed() }
        }
    }
    ...
    #[repr(u32)]
    #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord)]
    pub enum StkError_TYPE {
        WARNING = 0,
        DEBUG_WARNING = 1,
        FUNCTION_ARGUMENT = 2,
        FILE_NOT_FOUND = 3,
        FILE_UNKNOWN_FORMAT = 4,
        FILE_ERROR = 5,
        PROCESS_THREAD = 6,
        PROCESS_SOCKET = 7,
        PROCESS_SOCKET_IPADDR = 8,
        AUDIO_SYSTEM = 9,
        MIDI_SYSTEM = 10,
        UNSPECIFIED = 11,
    }
    ...
    extern "C" {
        #[link_name = "\u{1}STK_SINT8"]
        pub static Stk_STK_SINT8: Stk_STK_FORMAT;
    }
    extern "C" {
        #[link_name = "\u{1}STK_SINT16"]
        pub static Stk_STK_SINT16: Stk_STK_FORMAT;
    }
    extern "C" {
        #[link_name = "\u{1}STK_SINT32"]
        pub static Stk_STK_SINT32: Stk_STK_FORMAT;
    }
    extern "C" {
        #[link_name = "\u{1}MY_FLOAT32"]
        pub static Stk_MY_FLOAT32: Stk_STK_FORMAT;
    }
    extern "C" {
        #[link_name = "\u{1}MY_FLOAT64"]
        pub static Stk_MY_FLOAT64: Stk_STK_FORMAT;
    }
    extern "C" {
        #[link_name = "\u{1}srate"]
    ...
    extern "C" {
        #[link_name = "\u{1}rawwavepath"]
        pub static mut Stk_rawwavepath: string;
    }
    #[test]
    fn bindgen_test_layout_Stk() {
        assert_eq!(
            ::std::mem::size_of::<Stk>(),
            8usize,
            concat!("Size of: ", stringify!(Stk))
        );
        assert_eq!(
            ::std::mem::align_of::<Stk>(),
            8usize,
            concat!("Alignment of ", stringify!(Stk))
        );
    }
    extern "C" {
        #[doc = "! Static method which returns the current STK sample rate."]
        #[link_name = "\u{1}sampleRate"]
    ...
    extern "C" {
        ...
        #[link_name = "\u{1}handleError"]
        pub fn Stk_handleError(message: *const ::std::os::raw::c_char, type_: StkError_TYPE);
    }
    extern "C" {
        #[doc = "! Default constructor."]
        #[link_name = "\u{1}Stk"]
        pub fn Stk_Stk(this: *mut Stk);
    }
    impl Default for Stk {
        fn default() -> Self {
            unsafe { ::std::mem::zeroed() }
        }
    }
    impl Stk {
        ...
        #[inline]
        pub unsafe fn rawwavePath() -> string {
            Stk_rawwavePath()
        }
        #[inline]
        pub unsafe fn setRawwavePath(newPath: string) {
        ...
        #[inline]
        pub unsafe fn handleError(message: *const ::std::os::raw::c_char, type_: StkError_TYPE) {
    ...
    extern "C" {
        ...
        #[link_name = "\u{1}Stk_destructor"]
        pub fn Stk_Stk_destructor(this: *mut Stk);
    }
    #[repr(C)]
    pub struct WvOut {
        pub _base: Stk,
        ...
        pub fd: *mut FILE,
        pub data: *mut f64,
        pub fileType: WvOut_FILE_TYPE,
        pub dataType: Stk_STK_FORMAT,
        pub byteswap: bool,
        pub channels: ::std::os::raw::c_uint,
        pub counter: ::std::os::raw::c_ulong,
        pub totalCount: ::std::os::raw::c_ulong,
        pub str_filename: Chuck_String,
        pub start: ::std::os::raw::c_ulong,
        pub autoPrefix: Chuck_String,
        pub flush: ::std::os::raw::c_ulong,
        pub fileGain: f64,
        pub asyncIO: ::std::os::raw::c_ulong,
        pub asyncWriteThread: *mut XWriteThread,
    }
    pub type WvOut_FILE_TYPE = ::std::os::raw::c_ulong;
    extern "C" {
        #[link_name = "\u{1}WVOUT_RAW"]
        pub static WvOut_WVOUT_RAW: WvOut_FILE_TYPE;
    }
    extern "C" {
        #[link_name = "\u{1}WVOUT_WAV"]
        pub static WvOut_WVOUT_WAV: WvOut_FILE_TYPE;
    }
    extern "C" {
        #[link_name = "\u{1}WVOUT_SND"]
        pub static WvOut_WVOUT_SND: WvOut_FILE_TYPE;
    }
    extern "C" {
        #[link_name = "\u{1}WVOUT_AIF"]
        pub static WvOut_WVOUT_AIF: WvOut_FILE_TYPE;
    }
    extern "C" {
        #[link_name = "\u{1}WVOUT_MAT"]
        pub static WvOut_WVOUT_MAT: WvOut_FILE_TYPE;
    }
    #[test]
    fn bindgen_test_layout_WvOut() {
        assert_eq!(
            ::std::mem::size_of::<WvOut>(),
            584usize,
            concat!("Size of: ", stringify!(WvOut))
        );
        assert_eq!(
            ::std::mem::align_of::<WvOut>(),
            8usize,
            concat!("Alignment of ", stringify!(WvOut))
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).msg as *const _ as usize },
            8usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).fd as *const _ as usize },
            264usize,
            concat!("Offset of field: ", stringify!(WvOut), "::", stringify!(fd))
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).data as *const _ as usize },
            272usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).fileType as *const _ as usize },
            280usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).dataType as *const _ as usize },
            288usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).byteswap as *const _ as usize },
            296usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).channels as *const _ as usize },
            300usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).counter as *const _ as usize },
            304usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).totalCount as *const _ as usize },
            312usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).str_filename as *const _ as usize },
            320usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
                "::",
                stringify!(str_filename)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).start as *const _ as usize },
            432usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).autoPrefix as *const _ as usize },
            440usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
                "::",
                stringify!(autoPrefix)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).flush as *const _ as usize },
            552usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).fileGain as *const _ as usize },
            560usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).asyncIO as *const _ as usize },
            568usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<WvOut>())).asyncWriteThread as *const _ as usize },
            576usize,
            concat!(
                "Offset of field: ",
                stringify!(WvOut),
                "::",
                stringify!(asyncWriteThread)
            )
        );
    }
    extern "C" {
    ...
    extern "C" {
        #[link_name = "\u{1}fflush"]
        pub fn WvOut_fflush(this: *mut WvOut, stream: *mut FILE) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}fclose"]
        pub fn WvOut_fclose(this: *mut WvOut, stream: *mut FILE) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}fread"]
        pub fn WvOut_fread(
    ...
    extern "C" {
        ...
        #[doc = "*/"]
        #[link_name = "\u{1}openFile"]
        pub fn WvOut_openFile(
            this: *mut WvOut,
            fileName: *const ::std::os::raw::c_char,
            nChannels: ::std::os::raw::c_uint,
            type_: WvOut_FILE_TYPE,
            arg1: Stk_STK_FORMAT,
        );
    }
    extern "C" {
        #[doc = "! If a file is open, write out samples in the queue and then close it."]
        #[link_name = "\u{1}closeFile"]
        pub fn WvOut_closeFile(this: *mut WvOut);
    }
    extern "C" {
        #[doc = "! Return the number of sample frames output."]
        #[link_name = "\u{1}getFrames"]
        pub fn WvOut_getFrames(this: *const WvOut) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[doc = "! Return the number of seconds of data output."]
        #[link_name = "\u{1}getTime"]
        pub fn WvOut_getTime(this: *const WvOut) -> f64;
    }
    extern "C" {
        #[link_name = "\u{1}init"]
        pub fn WvOut_init(this: *mut WvOut);
    }
    extern "C" {
        #[link_name = "\u{1}setRawFile"]
        pub fn WvOut_setRawFile(this: *mut WvOut, fileName: *const ::std::os::raw::c_char) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}setWavFile"]
        pub fn WvOut_setWavFile(this: *mut WvOut, fileName: *const ::std::os::raw::c_char) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}closeWavFile"]
        pub fn WvOut_closeWavFile(this: *mut WvOut);
    }
    extern "C" {
        #[link_name = "\u{1}setSndFile"]
        pub fn WvOut_setSndFile(this: *mut WvOut, fileName: *const ::std::os::raw::c_char) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}closeSndFile"]
        pub fn WvOut_closeSndFile(this: *mut WvOut);
    }
    extern "C" {
        #[link_name = "\u{1}setAifFile"]
        pub fn WvOut_setAifFile(this: *mut WvOut, fileName: *const ::std::os::raw::c_char) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}closeAifFile"]
        pub fn WvOut_closeAifFile(this: *mut WvOut);
    }
    extern "C" {
        #[link_name = "\u{1}setMatFile"]
        pub fn WvOut_setMatFile(this: *mut WvOut, fileName: *const ::std::os::raw::c_char) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}closeMatFile"]
        pub fn WvOut_closeMatFile(this: *mut WvOut);
    }
    extern "C" {
        #[doc = "! Default constructor."]
        #[link_name = "\u{1}WvOut"]
        pub fn WvOut_WvOut(this: *mut WvOut);
    }
    extern "C" {
        ...
        pub fn WvOut_WvOut1(
            ...
            nChannels: ::std::os::raw::c_uint,
            type_: WvOut_FILE_TYPE,
            format: Stk_STK_FORMAT,
        );
    }
    impl Default for WvOut {
        fn default() -> Self {
            unsafe { ::std::mem::zeroed() }
        }
    }
    impl ::std::fmt::Debug for WvOut {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write ! ( f , "WvOut {{ msg: [{}], fd: {:?}, data: {:?}, fileType: {:?}, dataType: {:?}, byteswap: {:?}, channels: {:?}, counter: {:?}, totalCount: {:?}, str_filename: {:?}, start: {:?}, autoPrefix: {:?}, flush: {:?}, fileGain: {:?}, asyncIO: {:?}, asyncWriteThread: {:?} }}" , self . msg . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . fd , self . data , self . fileType , self . dataType , self . byteswap , self . channels , self . counter , self . totalCount , self . str_filename , self . start , self . autoPrefix , self . flush , self . fileGain , self . asyncIO , self . asyncWriteThread )
        }
    }
    impl WvOut {
        #[inline]
    ...
    extern "C" {
        #[doc = "! Class destructor."]
        #[link_name = "\u{1}WvOut_destructor"]
        pub fn WvOut_WvOut_destructor(this: *mut WvOut);
    }
    extern "C" {
    ...
    pub struct Chuck_IO_Serial {
        ...
        pub m_event_buffer: *mut CBufferSimple,
        pub m_fd: ::std::os::raw::c_int,
        pub m_cfd: *mut FILE,
        pub m_path: string,
        pub m_io_buf: *mut ::std::os::raw::c_uchar,
        pub m_io_buf_max: ::std::os::raw::c_ulong,
        pub m_io_buf_available: ::std::os::raw::c_ulong,
        pub m_io_buf_pos: ::std::os::raw::c_ulong,
        pub m_tmp_buf: *mut ::std::os::raw::c_uchar,
        pub m_tmp_buf_max: ::std::os::raw::c_ulong,
        pub m_asyncWriteRequests: CircularBuffer<Chuck_IO_Serial_Request>,
        pub m_writeBuffer: CircularBuffer<::std::os::raw::c_char>,
        pub m_flags: ::std::os::raw::c_long,
        pub m_iomode: ::std::os::raw::c_long,
        pub m_eof: ::std::os::raw::c_ulong,
        pub m_do_exit: ::std::os::raw::c_ulong,
        pub m_vmRef: *mut Chuck_VM,
    }
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
    pub struct Chuck_IO_Serial_Request {
        pub m_type: ::std::os::raw::c_ulong,
        pub m_num: ::std::os::raw::c_ulong,
        pub m_status: ::std::os::raw::c_ulong,
        pub m_val: ::std::os::raw::c_ulong,
    }
    #[repr(u32)]
    #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord)]
    pub enum Chuck_IO_Serial_Request_Status {
        RQ_STATUS_PENDING = 0,
        RQ_STATUS_SUCCESS = 1,
        RQ_STATUS_FAILURE = 2,
        RQ_STATUS_INVALID = 3,
    ...
    #[test]
    fn bindgen_test_layout_Chuck_IO_Serial_Request() {
        assert_eq!(
            ::std::mem::size_of::<Chuck_IO_Serial_Request>(),
            32usize,
            concat!("Size of: ", stringify!(Chuck_IO_Serial_Request))
        );
        assert_eq!(
            ::std::mem::align_of::<Chuck_IO_Serial_Request>(),
            8usize,
            concat!("Alignment of ", stringify!(Chuck_IO_Serial_Request))
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial_Request>())).m_type as *const _ as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial_Request),
                "::",
                stringify!(m_type)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial_Request>())).m_num as *const _ as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial_Request>())).m_status as *const _ as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial_Request>())).m_val as *const _ as usize
            },
            24usize,
            concat!(
                "Offset of field: ",
    ...
    extern "C" {
        ...
        pub static Chuck_IO_Serial_TYPE_NONE: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_BYTE"]
        pub static Chuck_IO_Serial_TYPE_BYTE: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_WORD"]
        pub static Chuck_IO_Serial_TYPE_WORD: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_INT"]
        pub static Chuck_IO_Serial_TYPE_INT: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_FLOAT"]
        pub static Chuck_IO_Serial_TYPE_FLOAT: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_STRING"]
        pub static Chuck_IO_Serial_TYPE_STRING: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_LINE"]
        pub static Chuck_IO_Serial_TYPE_LINE: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}TYPE_WRITE"]
        pub static Chuck_IO_Serial_TYPE_WRITE: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_2400"]
        pub static Chuck_IO_Serial_CK_BAUD_2400: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_4800"]
        pub static Chuck_IO_Serial_CK_BAUD_4800: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_9600"]
        pub static Chuck_IO_Serial_CK_BAUD_9600: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_19200"]
        pub static Chuck_IO_Serial_CK_BAUD_19200: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_38400"]
        pub static Chuck_IO_Serial_CK_BAUD_38400: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_7200"]
        pub static Chuck_IO_Serial_CK_BAUD_7200: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_14400"]
        pub static Chuck_IO_Serial_CK_BAUD_14400: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_28800"]
        pub static Chuck_IO_Serial_CK_BAUD_28800: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_57600"]
        pub static Chuck_IO_Serial_CK_BAUD_57600: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_76800"]
        pub static Chuck_IO_Serial_CK_BAUD_76800: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_115200"]
        pub static Chuck_IO_Serial_CK_BAUD_115200: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}CK_BAUD_230400"]
        pub static Chuck_IO_Serial_CK_BAUD_230400: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}s_serials"]
        pub static mut Chuck_IO_Serial_s_serials: list;
    }
    #[test]
    fn bindgen_test_layout_Chuck_IO_Serial() {
        assert_eq!(
            ::std::mem::size_of::<Chuck_IO_Serial>(),
            504usize,
            concat!("Size of: ", stringify!(Chuck_IO_Serial))
        );
        assert_eq!(
            ::std::mem::align_of::<Chuck_IO_Serial>(),
            8usize,
            concat!("Alignment of ", stringify!(Chuck_IO_Serial))
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_read_thread as *const _ as usize
            },
            208usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_read_thread)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_write_thread as *const _ as usize
            },
            216usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_write_thread)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_do_read_thread as *const _ as usize
            },
            224usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_do_read_thread)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_do_write_thread as *const _ as usize
            },
            225usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_do_write_thread)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_asyncRequests as *const _ as usize
            },
            232usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_asyncRequests)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_asyncResponses as *const _ as usize
            },
            264usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_asyncResponses)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_event_buffer as *const _ as usize
            },
            296usize,
            concat!(
                "Offset of field: ",
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_fd as *const _ as usize },
            304usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_cfd as *const _ as usize },
            312usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_path as *const _ as usize },
            320usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_io_buf as *const _ as usize },
            352usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_io_buf_max as *const _ as usize
            },
            360usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_io_buf_max)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_io_buf_available as *const _ as usize
            },
            368usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_io_buf_available)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_io_buf_pos as *const _ as usize
            },
            376usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_io_buf_pos)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_tmp_buf as *const _ as usize },
            384usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_tmp_buf_max as *const _ as usize
            },
            392usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_tmp_buf_max)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_asyncWriteRequests as *const _
                    as usize
            },
            400usize,
            concat!(
                ...
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_asyncWriteRequests)
            )
        );
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_writeBuffer as *const _ as usize
            },
            432usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
                "::",
                stringify!(m_writeBuffer)
            )
        );
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_flags as *const _ as usize },
            464usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_iomode as *const _ as usize },
            472usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_eof as *const _ as usize },
            480usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_do_exit as *const _ as usize },
            488usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
        ...
        assert_eq!(
            unsafe { &(*(::std::ptr::null::<Chuck_IO_Serial>())).m_vmRef as *const _ as usize },
            496usize,
            concat!(
                "Offset of field: ",
                stringify!(Chuck_IO_Serial),
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_shell_read_cb(
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_shell_write_cb(
            arg1: *mut ::std::os::raw::c_void,
        ) -> *mut ::std::os::raw::c_void;
    }
    extern "C" {
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_peek_buffer(this: *mut Chuck_IO_Serial) -> ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}pull_buffer"]
        pub fn Chuck_IO_Serial_pull_buffer(this: *mut Chuck_IO_Serial) -> ::std::os::raw::c_long;
    }
    extern "C" {
    ...
    impl Default for Chuck_IO_Serial {
        fn default() -> Self {
            unsafe { ::std::mem::zeroed() }
        }
    }
    impl ::std::fmt::Debug for Chuck_IO_Serial {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write ! ( f , "Chuck_IO_Serial {{ m_read_thread: {:?}, m_write_thread: {:?}, m_do_read_thread: {:?}, m_do_write_thread: {:?}, m_asyncRequests: {:?}, m_asyncResponses: {:?}, m_event_buffer: {:?}, m_fd: {:?}, m_cfd: {:?}, m_path: {:?}, m_io_buf: {:?}, m_io_buf_max: {:?}, m_io_buf_available: {:?}, m_io_buf_pos: {:?}, m_tmp_buf: {:?}, m_tmp_buf_max: {:?}, m_asyncWriteRequests: {:?}, m_writeBuffer: {:?}, m_flags: {:?}, m_iomode: {:?}, m_eof: {:?}, m_do_exit: {:?}, m_vmRef: {:?} }}" , self . m_read_thread , self . m_write_thread , self . m_do_read_thread , self . m_do_write_thread , self . m_asyncRequests , self . m_asyncResponses , self . m_event_buffer , self . m_fd , self . m_cfd , self . m_path , self . m_io_buf , self . m_io_buf_max , self . m_io_buf_available , self . m_io_buf_pos , self . m_tmp_buf , self . m_tmp_buf_max , self . m_asyncWriteRequests , self . m_writeBuffer , self . m_flags , self . m_iomode , self . m_eof , self . m_do_exit , self . m_vmRef )
        }
    }
    impl Chuck_IO_Serial {
        ...
        #[inline]
        pub unsafe fn peek_buffer(&mut self) -> ::std::os::raw::c_long {
            Chuck_IO_Serial_peek_buffer(self)
        }
        #[inline]
        pub unsafe fn pull_buffer(&mut self) -> ::std::os::raw::c_long {
            Chuck_IO_Serial_pull_buffer(self)
        }
        #[inline]
        pub unsafe fn buffer_bytes_to_tmp(
            &mut self,
            num_bytes: ::std::os::raw::c_long,
        ) -> ::std::os::raw::c_long {
        ...
        #[inline]
        pub unsafe fn handle_int_ascii(
            &mut self,
            arg1: *mut Chuck_IO_Serial_Request,
        ) -> ::std::os::raw::c_ulong {
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_can_wait(
            this: *mut ::std::os::raw::c_void,
        ) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}good"]
        pub fn Chuck_IO_Serial_good(this: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}close"]
        pub fn Chuck_IO_Serial_close(this: *mut ::std::os::raw::c_void);
    }
    extern "C" {
        #[link_name = "\u{1}flush"]
        pub fn Chuck_IO_Serial_flush(this: *mut ::std::os::raw::c_void);
    }
    extern "C" {
        #[link_name = "\u{1}mode"]
        pub fn Chuck_IO_Serial_mode(this: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}mode"]
        pub fn Chuck_IO_Serial_mode1(
            this: *mut ::std::os::raw::c_void,
            flag: ::std::os::raw::c_long,
        );
    }
    extern "C" {
        #[link_name = "\u{1}readLine"]
        pub fn Chuck_IO_Serial_readLine(this: *mut ::std::os::raw::c_void) -> *mut Chuck_String;
    }
    extern "C" {
        #[link_name = "\u{1}readInt"]
        pub fn Chuck_IO_Serial_readInt(
            this: *mut ::std::os::raw::c_void,
            flags: ::std::os::raw::c_long,
        ) -> ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}readFloat"]
        pub fn Chuck_IO_Serial_readFloat(this: *mut ::std::os::raw::c_void) -> f64;
    }
    extern "C" {
        #[link_name = "\u{1}readString"]
    ...
    extern "C" {
        #[link_name = "\u{1}eof"]
        pub fn Chuck_IO_Serial_eof(this: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}write"]
        pub fn Chuck_IO_Serial_write(this: *mut ::std::os::raw::c_void, val: *const string);
    }
    extern "C" {
        #[link_name = "\u{1}write"]
        pub fn Chuck_IO_Serial_write1(
            this: *mut ::std::os::raw::c_void,
            val: ::std::os::raw::c_long,
        );
    }
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_writeBytes(
            this: *mut ::std::os::raw::c_void,
            arr: *mut Chuck_Array4,
        );
    }
    extern "C" {
        #[link_name = "\u{1}write"]
        pub fn Chuck_IO_Serial_write3(this: *mut ::std::os::raw::c_void, val: f64);
    }
    extern "C" {
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_getBaudRate(
            this: *mut ::std::os::raw::c_void,
        ) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
    ...
    extern "C" {
        ...
        pub fn Chuck_IO_Serial_getLine(this: *mut ::std::os::raw::c_void) -> *mut Chuck_String;
    }
    extern "C" {
        #[link_name = "\u{1}getByte"]
        pub fn Chuck_IO_Serial_getByte(this: *mut ::std::os::raw::c_void)
            -> ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}getBytes"]
        pub fn Chuck_IO_Serial_getBytes(this: *mut ::std::os::raw::c_void) -> *mut Chuck_Array;
    }
    extern "C" {
        #[link_name = "\u{1}getInts"]
        pub fn Chuck_IO_Serial_getInts(this: *mut ::std::os::raw::c_void) -> *mut Chuck_Array;
    }
    extern "C" {
        #[link_name = "\u{1}getFloats"]
        pub fn Chuck_IO_Serial_getFloats(this: *mut ::std::os::raw::c_void) -> *mut Chuck_Array;
    }
    extern "C" {
        #[link_name = "\u{1}getString"]
        pub fn Chuck_IO_Serial_getString(this: *mut ::std::os::raw::c_void) -> *mut Chuck_String;
    }
    extern "C" {
        #[link_name = "\u{1}ready"]
        pub fn Chuck_IO_Serial_ready(this: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_ulong;
    }
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_WvOut_ptr_WvOut__bindgen_ty_id_81990_open1_ptr_WvOut_close1_allocator_open1_pair_open2_ptr_WvOut_ptr_WvOut_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_S_Symbol_ptr_Chuck_VM_Object__bindgen_ty_id_85143_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_S_Symbol__ptr_Chuck_VM_Object__bindgen_ty_id_85163_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_S_Symbol_ptr_Chuck_VM_Object__bindgen_ty_id_85182_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_Namespace_ptr_Chuck_Namespace__bindgen_ty_id_85305_open1_ptr_Chuck_Namespace_close1_allocator_open1_pair_open2_ptr_Chuck_Namespace_ptr_Chuck_Namespace_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_UGen_ptr_Chuck_UGen__bindgen_ty_id_86596_open1_ptr_Chuck_UGen_close1_allocator_open1_pair_open2_ptr_Chuck_UGen_ptr_Chuck_UGen_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_VM_Shred_ptr_Chuck_VM_Shred__bindgen_ty_id_86710_open1_ptr_Chuck_VM_Shred_close1_allocator_open1_pair_open2_ptr_Chuck_VM_Shred_ptr_Chuck_VM_Shred_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_pair_open0_basic_string_open1_char_char_traits_open2_char_close2_allocator_open2_char_close2_close1_ptr_Chuck_Context_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<pair<basic_string<::std::os::raw::c_char>, *mut Chuck_Context>>(),
            40usize,
            concat!(
                "Size of template specialization: ",
                stringify!(pair<basic_string<::std::os::raw::c_char>, *mut Chuck_Context>)
            )
        );
        assert_eq!(
            ::std::mem::align_of::<pair<basic_string<::std::os::raw::c_char>, *mut Chuck_Context>>(
            ),
            8usize,
            concat!(
                "Alignment of template specialization: ",
    ...
    #[test]
    fn __bindgen_test_layout_CircularBuffer_open0_Chuck_IO_Serial_Request_close0_instantiation() {
        assert_eq!(
            ::std::mem::size_of::<CircularBuffer<Chuck_IO_Serial_Request>>(),
            32usize,
            concat!(
                "Size of template specialization: ",
                stringify!(CircularBuffer<Chuck_IO_Serial_Request>)
            )
        );
        assert_eq!(
            ::std::mem::align_of::<CircularBuffer<Chuck_IO_Serial_Request>>(),
            8usize,
            concat!(
                "Alignment of template specialization: ",
                stringify!(CircularBuffer<Chuck_IO_Serial_Request>)
    ...
    #[test]
    fn __bindgen_test_layout_CircularBuffer_open0_Chuck_IO_Serial_Request_close0_instantiation_1() {
        assert_eq!(
            ::std::mem::size_of::<CircularBuffer<Chuck_IO_Serial_Request>>(),
            32usize,
            concat!(
    ...
    #[test]
    fn __bindgen_test_layout_CircularBuffer_open0_Chuck_IO_Serial_Request_close0_instantiation_2() {
        assert_eq!(
            ::std::mem::size_of::<CircularBuffer<Chuck_IO_Serial_Request>>(),
            32usize,
            concat!(
    ...
    #[test]
    fn __bindgen_test_layout_CircularBuffer_open0_char_close0_instantiation() {
        assert_eq!(
            ::std::mem::size_of::<CircularBuffer<::std::os::raw::c_char>>(),
            32usize,
            concat!(
                "Size of template specialization: ",
                stringify!(CircularBuffer<::std::os::raw::c_char>)
            )
        );
        assert_eq!(
            ::std::mem::align_of::<CircularBuffer<::std::os::raw::c_char>>(),
            8usize,
            concat!(
                "Alignment of template specialization: ",
                stringify!(CircularBuffer<::std::os::raw::c_char>)
