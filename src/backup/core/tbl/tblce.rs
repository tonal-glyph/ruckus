...
extern "C" {
    pub fn U_BoolList(head: ::std::os::raw::c_ulong, tail: root::U_boolList) -> root::U_boolList;
}
pub type binder = *mut root::binder_;
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
pub struct binder_ {
    pub key: *mut ::std::os::raw::c_void,
    pub value: *mut ::std::os::raw::c_void,
    pub next: root::binder,
    pub prevtop: *mut ::std::os::raw::c_void,
}
// #[test]
// fn bindgen_test_layout_binder_() {
//     assert_eq!(
//         ::std::mem::size_of::<binder_>(),
//         32usize,
//         concat!("Size of: ", stringify!(binder_))
//     );
//     assert_eq!(
//         ::std::mem::align_of::<binder_>(),
//         8usize,
//         concat!("Alignment of ", stringify!(binder_))
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<binder_>())).key as *const _ as usize },
//         0usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(binder_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<binder_>())).value as *const _ as usize },
//         8usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(binder_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<binder_>())).next as *const _ as usize },
//         16usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(binder_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<binder_>())).prevtop as *const _ as usize },
//         24usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(binder_),
...
pub struct TAB_table_ {
    ...
    pub table: *mut root::binder,
    pub top: *mut ::std::os::raw::c_void,
    pub eq_func: root::TAB_eq_func,
    pub hash_func: root::TAB_hash_func,
}
// #[test]
// fn bindgen_test_layout_TAB_table_() {
//     assert_eq!(
//         ::std::mem::size_of::<TAB_table_>(),
//         40usize,
//         concat!("Size of: ", stringify!(TAB_table_))
//     );
//     assert_eq!(
//         ::std::mem::align_of::<TAB_table_>(),
//         8usize,
//         concat!("Alignment of ", stringify!(TAB_table_))
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<TAB_table_>())).size as *const _ as usize },
//         0usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(TAB_table_),
//             "::",
//             stringify!(size)
//         )
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<TAB_table_>())).table as *const _ as usize },
//         8usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(TAB_table_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<TAB_table_>())).top as *const _ as usize },
//         16usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(TAB_table_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<TAB_table_>())).eq_func as *const _ as usize },
//         24usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(TAB_table_),
...
//     );
//     assert_eq!(
//         unsafe { &(*(::std::ptr::null::<TAB_table_>())).hash_func as *const _ as usize },
//         32usize,
//         concat!(
//             "Offset of field: ",
//             stringify!(TAB_table_),
