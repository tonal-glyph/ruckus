...
impl HidOut {
    #[inline]
    pub unsafe fn open(&mut self, device_num: ::std::os::raw::c_ulong) -> ::std::os::raw::c_ulong {
...
extern "C" {
    #[link_name = "\u{1}send"]
    pub fn HidIn_send(this: *mut root::HidIn, msg: *const root::HidMsg) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}empty"]
...
extern "C" {
    #[link_name = "\u{1}recv"]
    pub fn HidIn_recv(this: *mut root::HidIn, msg: *mut root::HidMsg) -> ::std::os::raw::c_ulong;
}
extern "C" {
    #[link_name = "\u{1}name"]
...
impl HidInManager {
    ...
    #[inline]
    pub unsafe fn cb_hid_input(arg1: *mut ::std::os::raw::c_void) -> *mut ::std::os::raw::c_void {
