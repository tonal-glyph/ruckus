...
extern "C" {
    pub fn fread(__ptr: *mut c_void, __size: usize, __n: usize, __stream: *mut FILE) -> c_ulong;
}
extern "C" {
    pub fn fwrite(__ptr: *const c_void, __size: usize, __n: usize, __s: *mut FILE) -> c_ulong;
}
extern "C" {
...
pub type yytype_uint16 = c_ushort;
...
extern "C" {
    pub static mut yychar: c_int;
}
extern "C" {
    pub static mut yynerrs: c_int;
}
