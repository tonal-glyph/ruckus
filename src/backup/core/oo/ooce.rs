...
pub mod root {
    ...
    pub mod std {
        ...
        pub mod __cxx11 {
            ...
            pub type money_get_string_type = root::std::__cxx11::basic_string<_CharT>;
            impl Default for money_get {
                fn default() -> Self {
                    unsafe { ::std::mem::zeroed() }
                }
            }
            ...
            pub type money_put_string_type = root::std::__cxx11::basic_string<_CharT>;
            impl Default for money_put {
                fn default() -> Self {
                    unsafe { ::std::mem::zeroed() }
                }
            }
            ...
            pub type messages_string_type = root::std::__cxx11::basic_string<_CharT>;
            ...
            pub struct messages_byname {
                pub _base: root::std::__cxx11::messages,
            }
            pub type messages_byname_char_type<_CharT> = _CharT;
            pub type messages_byname_string_type = root::std::__cxx11::basic_string<_CharT>;
            impl Default for messages_byname {
                fn default() -> Self {
                    unsafe { ::std::mem::zeroed() }
                }
            }
            #[repr(C)]
            pub struct wstring_convert<_Elem> {
                pub _M_cvt: root::std::unique_ptr,
                pub _M_byte_err_string: root::std::__cxx11::wstring_convert_byte_string,
                pub _M_wide_err_string: root::std::__cxx11::wstring_convert_wide_string<_Elem>,
                pub _M_state: root::std::__cxx11::wstring_convert_state_type,
                pub _M_count: usize,
                pub _M_with_cvtstate: bool,
                pub _M_with_strings: bool,
                pub _phantom_0: ::std::marker::PhantomData<::std::cell::UnsafeCell<_Elem>>,
            }
            pub type wstring_convert_byte_string = root::std::__cxx11::basic_string<_CharT>;
            pub type wstring_convert_wide_string<_Elem> = root::std::__cxx11::basic_string<_Elem>;
            pub type wstring_convert_state_type = [u8; 0usize];
            pub type wstring_convert_int_type<_Elem> =
                root::std::__cxx11::wstring_convert_wide_string<_Elem>;
            impl<_Elem> Default for wstring_convert<_Elem> {
                fn default() -> Self {
                    unsafe { ::std::mem::zeroed() }
                }
            }
            impl<_Elem> ::std::fmt::Debug for wstring_convert<_Elem> {
                fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    write ! ( f , "wstring_convert {{ _M_cvt: {:?}, _M_byte_err_string: {:?}, _M_wide_err_string: {:?}, _M_count: {:?}, _M_with_cvtstate: {:?}, _M_with_strings: {:?} }}" , self . _M_cvt , self . _M_byte_err_string , self . _M_wide_err_string , self . _M_count , self . _M_with_cvtstate , self . _M_with_strings )
                }
            }
        }
        extern "C" {
        ...
        pub mod __detail {
            ...
            impl<_String, _CharT> Default for _Quoted_string<_String, _CharT> {
                fn default() -> Self {
                    unsafe { ::std::mem::zeroed() }
                }
            }
