...
pub mod root {
    ...
    pub mod std {
        ...
        pub mod __cxx11 {
            ...
            pub struct basic_string__bindgen_ty_2<_CharT> {
                pub _M_local_buf:
                    crate::core::ctype::ctypec::root::__BindgenUnionField<*mut _CharT>,
                pub _M_allocated_capacity:
                    crate::core::ctype::ctypec::root::__BindgenUnionField<basic_string_size_type>,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_WvOut_ptr_WvOut__bindgen_ty_id_65457_open1_ptr_WvOut_close1_allocator_open1_pair_open2_ptr_WvOut_ptr_WvOut_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    fn __bindgen_test_layout_pair_open0_basic_string_open1_char_char_traits_open2_char_close2_allocator_open2_char_close2_close1_unsigned_long_close0_instantiation(
        ...
        assert_eq!(
            ::std::mem::size_of::<
                pair<basic_string<::std::os::raw::c_char>, ::std::os::raw::c_ulong>,
            >(),
            40usize,
            concat!(
                "Size of template specialization: ",
                stringify!(pair<basic_string<::std::os::raw::c_char>, ::std::os::raw::c_ulong>)
            )
        );
        assert_eq!(
            ::std::mem::align_of::<
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_S_Symbol_ptr_Chuck_VM_Object__bindgen_ty_id_68727_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_S_Symbol__ptr_Chuck_VM_Object__bindgen_ty_id_68747_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_S_Symbol_ptr_Chuck_VM_Object__bindgen_ty_id_68766_open1_ptr_S_Symbol__close1_allocator_open1_pair_open2_ptr_S_Symbol__ptr_Chuck_VM_Object_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_Namespace_ptr_Chuck_Namespace__bindgen_ty_id_68889_open1_ptr_Chuck_Namespace_close1_allocator_open1_pair_open2_ptr_Chuck_Namespace_ptr_Chuck_Namespace_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    fn __bindgen_test_layout_pair_open0_basic_string_open1_char_char_traits_open2_char_close2_allocator_open2_char_close2_close1_basic_string_open1_char_char_traits_open2_char_close2_allocator_open2_char_close2_close1_close0_instantiation(
        ...
        assert_eq!(
            ::std::mem::size_of::<
                pair<basic_string<::std::os::raw::c_char>, basic_string<::std::os::raw::c_char>>,
            >(),
            64usize,
            concat!(
                "Size of template specialization: ",
                stringify!(
                    pair<
                        basic_string<::std::os::raw::c_char>,
                        basic_string<::std::os::raw::c_char>,
                    >
                )
            )
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_UGen_ptr_Chuck_UGen__bindgen_ty_id_70088_open1_ptr_Chuck_UGen_close1_allocator_open1_pair_open2_ptr_Chuck_UGen_ptr_Chuck_UGen_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_Chuck_VM_Shred_ptr_Chuck_VM_Shred__bindgen_ty_id_70202_open1_ptr_Chuck_VM_Shred_close1_allocator_open1_pair_open2_ptr_Chuck_VM_Shred_ptr_Chuck_VM_Shred_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
