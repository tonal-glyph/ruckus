...
pub mod root {
    ...
    pub mod std {
        ...
        pub mod __cxx11 {
            ...
            pub struct basic_string__bindgen_ty_2<_CharT> {
                pub _M_local_buf: crate::core::dynl::dynl::root::__BindgenUnionField<*mut _CharT>,
                pub _M_allocated_capacity:
                    crate::core::dynl::dynl::root::__BindgenUnionField<basic_string_size_type>,
    ...
    #[test]
    fn __bindgen_test_layout_map_open0_ptr_WvOut_ptr_WvOut__bindgen_ty_id_48594_open1_ptr_WvOut_close1_allocator_open1_pair_open2_ptr_WvOut_ptr_WvOut_close2_close1_close0_instantiation(
    ) {
        assert_eq!(
            ::std::mem::size_of::<map>(),
            48usize,
