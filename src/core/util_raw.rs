...
extern "C" {
    ...
    pub static mut ahh_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}britestk_data"]
    pub static mut britestk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}dope_data"]
    pub static mut dope_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}eee_data"]
    pub static mut eee_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}fwavblnk_data"]
    pub static mut fwavblnk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}halfwave_data"]
    pub static mut halfwave_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}impuls10_data"]
    pub static mut impuls10_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}impuls20_data"]
    pub static mut impuls20_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}impuls40_data"]
    pub static mut impuls40_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}mand1_data"]
    pub static mut mand1_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}mandpluk_data"]
    pub static mut mandpluk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}marmstk1_data"]
    pub static mut marmstk1_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}ooo_data"]
    pub static mut ooo_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}peksblnk_data"]
    pub static mut peksblnk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}ppksblnk_data"]
    pub static mut ppksblnk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}silence_data"]
    pub static mut silence_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}sineblnk_data"]
    pub static mut sineblnk_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}sinewave_data"]
    pub static mut sinewave_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}snglpeak_data"]
    pub static mut snglpeak_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}twopeaks_data"]
    pub static mut twopeaks_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}glot_ahh_data"]
    pub static mut glot_ahh_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}glot_eee_data"]
    pub static mut glot_eee_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}glot_ooo_data"]
    pub static mut glot_ooo_data: [f32; 0usize];
}
extern "C" {
    #[link_name = "\u{1}glot_pop_data"]
    pub static mut glot_pop_data: [f32; 0usize];
}
extern "C" {
