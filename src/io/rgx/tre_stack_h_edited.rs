...
pub type tre_stack_t = tre_stack_rec;
extern "C" {
    pub fn tre_stack_new(size: c_int, max_size: c_int, increment: c_int) -> *mut tre_stack_t;
}
extern "C" {
    pub fn tre_stack_destroy(s: *mut tre_stack_t);
}
extern "C" {
    pub fn tre_stack_num_objects(s: *mut tre_stack_t) -> c_int;
}
extern "C" {
    pub fn tre_stack_push_voidptr(s: *mut tre_stack_t, value: *mut c_void) -> reg_errcode_t;
}
extern "C" {
    pub fn tre_stack_push_int(s: *mut tre_stack_t, value: c_int) -> reg_errcode_t;
}
extern "C" {
    pub fn tre_stack_pop_voidptr(s: *mut tre_stack_t) -> *mut c_void;
}
extern "C" {
    pub fn tre_stack_pop_int(s: *mut tre_stack_t) -> c_int;
}
