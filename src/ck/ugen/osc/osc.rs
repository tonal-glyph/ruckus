...
pub mod root {
    ...
    extern "C" {
        pub fn osc_query(query: *mut root::Chuck_DL_Query) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        pub fn osc_ctor(
            SELF: *mut root::Chuck_Object,
    ...
    extern "C" {
        pub fn genX_query(query: *mut root::Chuck_DL_Query) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        pub fn genX_ctor(
            SELF: *mut root::Chuck_Object,
    ...
    extern "C" {
        #[link_name = "\u{1}_Z9_asymwarpdd"]
        pub fn _asymwarp(inval: f64, k: f64) -> f64;
    }
    extern "C" {
        #[link_name = "\u{1}_Z8_symwarpdd"]
