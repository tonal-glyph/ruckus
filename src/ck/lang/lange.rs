...
#![feature(libc)]
//* Base classes and objects for the ChucK runtime language interface implementation.
extern crate libc;
...
#[repr(C)]
pub struct Chuck_UAnaBlobProxy__bindgen_vtable(libc::c_void);
#[repr(C)]
#[derive(Debug)]
pub struct Chuck_UAnaBlobProxy {
    pub vtable_: *const Chuck_UAnaBlobProxy__bindgen_vtable,
    pub m_blob: *mut Chuck_Object,
}
extern "C" {
    #[link_name = "\u{1}when"]
    pub fn Chuck_UAnaBlobProxy_when(this: *mut Chuck_UAnaBlobProxy) -> *mut f64;
}
extern "C" {
    #[link_name = "\u{1}fvals"]
    pub fn Chuck_UAnaBlobProxy_fvals(this: *mut Chuck_UAnaBlobProxy) -> *mut Chuck_Array8;
}
extern "C" {
    #[link_name = "\u{1}cvals"]
    pub fn Chuck_UAnaBlobProxy_cvals(this: *mut Chuck_UAnaBlobProxy) -> *mut Chuck_Array16;
}
extern "C" {
    #[link_name = "\u{1}realblob"]
    pub fn Chuck_UAnaBlobProxy_realblob(this: *mut Chuck_UAnaBlobProxy) -> *mut Chuck_Object;
}
extern "C" {
    #[link_name = "\u{1}Chuck_UAnaBlobProxy"]
    pub fn Chuck_UAnaBlobProxy_Chuck_UAnaBlobProxy(
        this: *mut Chuck_UAnaBlobProxy,
        blob: *mut Chuck_Object,
    );
}
impl Chuck_UAnaBlobProxy {
    #[inline]
    pub unsafe fn when(&mut self) -> *mut f64 {
        Chuck_UAnaBlobProxy_when(self)
    }
    #[inline]
    pub unsafe fn fvals(&mut self) -> *mut Chuck_Array8 {
        Chuck_UAnaBlobProxy_fvals(self)
    }
    #[inline]
    pub unsafe fn cvals(&mut self) -> *mut Chuck_Array16 {
        Chuck_UAnaBlobProxy_cvals(self)
    }
    #[inline]
    pub unsafe fn realblob(&mut self) -> *mut Chuck_Object {
        Chuck_UAnaBlobProxy_realblob(self)
    }
    #[inline]
    pub unsafe fn new(blob: *mut Chuck_Object) -> Self {
        let mut __bindgen_tmp = uninitialized();
        Chuck_UAnaBlobProxy_Chuck_UAnaBlobProxy(&mut __bindgen_tmp, blob);
        __bindgen_tmp
    }
}
extern "C" {
    #[link_name = "\u{1}Chuck_UAnaBlobProxy_destructor"]
    pub fn Chuck_UAnaBlobProxy_Chuck_UAnaBlobProxy_destructor(this: *mut Chuck_UAnaBlobProxy);
}
extern "C" {
    pub fn getBlobProxy(uana: *const Chuck_UAna) -> *mut Chuck_UAnaBlobProxy;
}
//-----------------------------------------------------------------------------
// shred API
//-----------------------------------------------------------------------------
...
#[repr(C)]
#[derive(Debug)]
pub struct Data_Exception {
    pub _address: u8,
}
extern "C" {
    #[link_name = "\u{1}Data_Exception"]
    pub fn Data_Exception_Data_Exception(this: *mut Data_Exception);
}
extern "C" {
    #[link_name = "\u{1}Data_Exception_destructor"]
    pub fn Data_Exception_Data_Exception_destructor(this: *mut Data_Exception);
}
impl Data_Exception {
    #[inline]
    pub unsafe fn new() -> Self {
        let mut __bindgen_tmp = uninitialized();
        Data_Exception_Data_Exception(&mut __bindgen_tmp);
        __bindgen_tmp
    }
    #[inline]
    pub unsafe fn destruct(&mut self) {
        Data_Exception_Data_Exception_destructor(self)
    }
}
//-----------------------------------------------------------------------------
// MidiMsg API
