...
pub mod root {
    ...
    pub struct Chuck_Console {
        pub _base: root::Chuck_Shell_UI,
    }
    extern "C" {
        #[link_name = "\u{1}_ZN13Chuck_ConsoleC1Ev"]
        pub fn Chuck_Console_Chuck_Console(this: *mut root::Chuck_Console);
    }
    impl Chuck_Console {
        #[inline]
        pub unsafe fn new() -> Self {
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN13Chuck_ConsoleD1Ev"]
        pub fn Chuck_Console_Chuck_Console_destructor(this: *mut root::Chuck_Console);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN13Chuck_Console4initEv"]
        pub fn Chuck_Console_init(this: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN13Chuck_Console12next_commandERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERS5_"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN13Chuck_Console11next_resultERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE"]
