...
pub mod root {
    ...
    pub const MAX_BUNDLE_NESTING: u32 = 32;
    ...
    pub const OSCINBUFSIZE: u32 = 8192;
    pub const OSCMESGSIZE: u32 = 8192;
    pub const OSCINBOXDEF: u32 = 2;
    pub const OSCINBOXMAX: u32 = 256;
    pub const OSC_ADDRESS_QUEUE_MAX: u32 = 32768;
    pub mod std {
        #[allow(unused_imports)]
    ...
    extern "C" {
        #[link_name = "\u{1}_Z12PatternMatchPKcS0_"]
        pub fn PatternMatch(
    ...
    pub struct OSCTimeTag {
        pub seconds: root::uint32,
        pub fraction: root::uint32,
    }
    extern "C" {
        #[link_name = "\u{1}_Z17OSCTT_CurrentTimev"]
        pub fn OSCTT_CurrentTime() -> root::OSCTimeTag;
    }
    extern "C" {
        #[link_name = "\u{1}_Z17OSCTT_Immediatelyv"]
        pub fn OSCTT_Immediately() -> root::OSCTimeTag;
    }
    extern "C" {
        #[link_name = "\u{1}_Z28OSCTT_BiggestPossibleTimeTagv"]
        pub fn OSCTT_BiggestPossibleTimeTag() -> root::OSCTimeTag;
    }
    extern "C" {
        #[link_name = "\u{1}_Z17OSCTT_PlusSeconds10OSCTimeTagf"]
        pub fn OSCTT_PlusSeconds(
            original: root::OSCTimeTag,
            secondsOffset: f32,
        ) -> root::OSCTimeTag;
    }
    extern "C" {
        #[link_name = "\u{1}_Z13OSCTT_Compare10OSCTimeTagS_"]
        pub fn OSCTT_Compare(
            left: root::OSCTimeTag,
            right: root::OSCTimeTag,
        ) -> ::std::os::raw::c_int;
    }
    pub type int4byte = ::std::os::raw::c_int;
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct OSCbuf_struct {
        pub buffer: *mut ::std::os::raw::c_char,
        pub size: ::std::os::raw::c_int,
        pub bufptr: *mut ::std::os::raw::c_char,
        pub state: ::std::os::raw::c_int,
        pub thisMsgSize: *mut root::int4byte,
        pub prevCounts: [*mut root::int4byte; 32usize],
        pub bundleDepth: ::std::os::raw::c_int,
        pub typeStringPtr: *mut ::std::os::raw::c_char,
        pub gettingFirstUntypedArg: ::std::os::raw::c_int,
    }
    pub type OSCbuf = root::OSCbuf_struct;
    extern "C" {
        #[link_name = "\u{1}_Z14OSC_initBufferP13OSCbuf_structiPc"]
        pub fn OSC_initBuffer(
            buf: *mut root::OSCbuf,
            size: ::std::os::raw::c_int,
            byteArray: *mut ::std::os::raw::c_char,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_Z15OSC_resetBufferP13OSCbuf_struct"]
        pub fn OSC_resetBuffer(buf: *mut root::OSCbuf);
    }
    extern "C" {
        #[link_name = "\u{1}_Z17OSC_isBufferEmptyP13OSCbuf_struct"]
        pub fn OSC_isBufferEmpty(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z21OSC_freeSpaceInBufferP13OSCbuf_struct"]
        pub fn OSC_freeSpaceInBuffer(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z16OSC_isBufferDoneP13OSCbuf_struct"]
        pub fn OSC_isBufferDone(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z13OSC_getPacketP13OSCbuf_struct"]
        pub fn OSC_getPacket(buf: *mut root::OSCbuf) -> *mut ::std::os::raw::c_char;
    }
    extern "C" {
        #[link_name = "\u{1}_Z14OSC_packetSizeP13OSCbuf_struct"]
        pub fn OSC_packetSize(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z14OSC_openBundleP13OSCbuf_struct10OSCTimeTag"]
        pub fn OSC_openBundle(
            buf: *mut root::OSCbuf,
            tt: root::OSCTimeTag,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z15OSC_closeBundleP13OSCbuf_struct"]
        pub fn OSC_closeBundle(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z19OSC_closeAllBundlesP13OSCbuf_struct"]
        pub fn OSC_closeAllBundles(buf: *mut root::OSCbuf) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z16OSC_writeAddressP13OSCbuf_structPc"]
        pub fn OSC_writeAddress(
            buf: *mut root::OSCbuf,
            name: *mut ::std::os::raw::c_char,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z24OSC_writeAddressAndTypesP13OSCbuf_structPcS1_"]
        pub fn OSC_writeAddressAndTypes(
            buf: *mut root::OSCbuf,
            name: *mut ::std::os::raw::c_char,
            types: *mut ::std::os::raw::c_char,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z17OSC_writeFloatArgP13OSCbuf_structf"]
        pub fn OSC_writeFloatArg(buf: *mut root::OSCbuf, arg: f32) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z18OSC_writeFloatArgsP13OSCbuf_structiPf"]
        pub fn OSC_writeFloatArgs(
            buf: *mut root::OSCbuf,
            numFloats: ::std::os::raw::c_int,
            args: *mut f32,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z15OSC_writeIntArgP13OSCbuf_structi"]
        pub fn OSC_writeIntArg(
            buf: *mut root::OSCbuf,
            arg: root::int4byte,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_Z18OSC_writeStringArgP13OSCbuf_structPc"]
        pub fn OSC_writeStringArg(
            buf: *mut root::OSCbuf,
            arg: *mut ::std::os::raw::c_char,
        ) -> ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}OSC_errorMessage"]
        pub static mut OSC_errorMessage: *const ::std::os::raw::c_char;
    }
    extern "C" {
        #[link_name = "\u{1}_Z25OSC_effectiveStringLengthPc"]
        pub fn OSC_effectiveStringLength(
    ...
    #[repr(C)]
    pub struct OSC_Transmitter__bindgen_vtable(::std::os::raw::c_void);
    #[repr(C)]
    pub struct OSC_Transmitter {
        pub vtable_: *const OSC_Transmitter__bindgen_vtable,
        pub _buffer: [::std::os::raw::c_char; 2048usize],
        pub _osc: root::OSCbuf,
        pub _out: *mut root::UDP_Transmitter,
        pub _holdMessage: bool,
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter4initEv"]
        pub fn OSC_Transmitter_init(this: *mut root::OSC_Transmitter);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter7setHostEPci"]
        pub fn OSC_Transmitter_setHost(
            this: *mut root::OSC_Transmitter,
            host: *mut ::std::os::raw::c_char,
            port: ::std::os::raw::c_int,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter10addMessageEPcS0_z"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter10openBundleE10OSCTimeTag"]
        pub fn OSC_Transmitter_openBundle(this: *mut root::OSC_Transmitter, t: root::OSCTimeTag);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter11closeBundleEv"]
        pub fn OSC_Transmitter_closeBundle(this: *mut root::OSC_Transmitter);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter12startMessageEPc"]
        pub fn OSC_Transmitter_startMessage(
            this: *mut root::OSC_Transmitter,
            spec: *mut ::std::os::raw::c_char,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter12startMessageEPcS0_"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter6addIntEi"]
        pub fn OSC_Transmitter_addInt(this: *mut root::OSC_Transmitter, i: root::int4byte);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter8addFloatEf"]
        pub fn OSC_Transmitter_addFloat(this: *mut root::OSC_Transmitter, f: f32);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter9addStringEPc"]
        pub fn OSC_Transmitter_addString(
            this: *mut root::OSC_Transmitter,
            s: *mut ::std::os::raw::c_char,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter11packetReadyEv"]
        pub fn OSC_Transmitter_packetReady(this: *mut root::OSC_Transmitter) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter11holdMessageEb"]
        pub fn OSC_Transmitter_holdMessage(this: *mut root::OSC_Transmitter, arg: bool);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter10tryMessageEv"]
        pub fn OSC_Transmitter_tryMessage(this: *mut root::OSC_Transmitter);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter11kickMessageEv"]
        pub fn OSC_Transmitter_kickMessage(this: *mut root::OSC_Transmitter);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_Transmitter7presendEPci"]
        pub fn OSC_Transmitter_presend(
            this: *mut root::OSC_Transmitter,
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_TransmitterC1Ev"]
        pub fn OSC_Transmitter_OSC_Transmitter(this: *mut root::OSC_Transmitter);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_TransmitterC1EP15UDP_Transmitter"]
        pub fn OSC_Transmitter_OSC_Transmitter1(
            this: *mut root::OSC_Transmitter,
            out: *mut root::UDP_Transmitter,
        );
    }
    impl OSC_Transmitter {
        ...
        #[inline]
        pub unsafe fn openBundle(&mut self, t: root::OSCTimeTag) {
        ...
        #[inline]
        pub unsafe fn startMessage(&mut self, spec: *mut ::std::os::raw::c_char) {
            OSC_Transmitter_startMessage(self, spec)
        }
        #[inline]
        pub unsafe fn startMessage1(
            &mut self,
            address: *mut ::std::os::raw::c_char,
            args: *mut ::std::os::raw::c_char,
        ) {
        ...
        #[inline]
        pub unsafe fn addInt(&mut self, i: root::int4byte) {
        ...
        #[inline]
        pub unsafe fn addString(&mut self, s: *mut ::std::os::raw::c_char) {
        ...
        #[inline]
        pub unsafe fn new1(out: *mut root::UDP_Transmitter) -> Self {
            let mut __bindgen_tmp = ::std::mem::uninitialized();
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN15OSC_TransmitterD1Ev"]
        pub fn OSC_Transmitter_OSC_Transmitter_destructor(this: *mut root::OSC_Transmitter);
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct OSCMesg {
        ...
        pub recvtime: f64,
        pub timetag: ::std::os::raw::c_long,
    }
    #[repr(C)]
    pub struct UDP_Subscriber__bindgen_vtable(::std::os::raw::c_void);
    #[repr(C)]
    #[derive(Debug)]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN14UDP_Subscriber9subscribeEi"]
        pub fn UDP_Subscriber_subscribe(
            this: *mut ::std::os::raw::c_void,
            port: ::std::os::raw::c_int,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN14UDP_Subscriber11unsubscribeEv"]
        pub fn UDP_Subscriber_unsubscribe(this: *mut ::std::os::raw::c_void) -> bool;
    }
    #[repr(C)]
    #[derive(Debug)]
    pub struct OSC_Receiver {
        pub _base: root::UDP_Subscriber,
        pub _port: ::std::os::raw::c_int,
        pub _tmp_port: ::std::os::raw::c_int,
        pub _io_mutex: *mut root::XMutex,
        pub _address_mutex: *mut root::XMutex,
        pub _meep: root::OSCMesg,
        pub _inbox: *mut root::OSCMesg,
        pub _inbox_size: ::std::os::raw::c_int,
        pub _started: bool,
        pub _in_read: ::std::os::raw::c_int,
        pub _in_write: ::std::os::raw::c_int,
        pub _address_space: *mut *mut root::OSC_Address_Space,
        pub _address_size: ::std::os::raw::c_int,
        pub _address_num: ::std::os::raw::c_int,
        pub m_event_buffer: *mut root::CBufferSimple,
        pub m_vmRef: *mut root::Chuck_VM,
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver4initEv"]
        pub fn OSC_Receiver_init(this: *mut root::OSC_Receiver);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver12bind_to_portEi"]
        pub fn OSC_Receiver_bind_to_port(
            this: *mut root::OSC_Receiver,
            port: ::std::os::raw::c_int,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver10close_sockEv"]
        pub fn OSC_Receiver_close_sock(this: *mut root::OSC_Receiver);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver9recv_mesgEv"]
        pub fn OSC_Receiver_recv_mesg(this: *mut root::OSC_Receiver);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver6listenEi"]
        pub fn OSC_Receiver_listen(
            this: *mut root::OSC_Receiver,
            port: ::std::os::raw::c_int,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver6listenEv"]
        pub fn OSC_Receiver_listen1(this: *mut root::OSC_Receiver) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver13stopListeningEv"]
        pub fn OSC_Receiver_stopListening(this: *mut root::OSC_Receiver);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver5parseEPci"]
        pub fn OSC_Receiver_parse(
            this: *mut root::OSC_Receiver,
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver11handle_mesgEPci"]
        pub fn OSC_Receiver_handle_mesg(
            this: *mut root::OSC_Receiver,
            arg1: *mut ::std::os::raw::c_char,
            len: ::std::os::raw::c_int,
        );
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver13handle_bundleEPci"]
        pub fn OSC_Receiver_handle_bundle(
            this: *mut root::OSC_Receiver,
            arg1: *mut ::std::os::raw::c_char,
            len: ::std::os::raw::c_int,
        );
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver8set_mesgEP7OSCMesgPci"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver10next_writeEv"]
        pub fn OSC_Receiver_next_write(this: *mut root::OSC_Receiver);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver9next_readEv"]
        pub fn OSC_Receiver_next_read(this: *mut root::OSC_Receiver) -> *mut root::OSCMesg;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver8has_mesgEv"]
        pub fn OSC_Receiver_has_mesg(this: *mut root::OSC_Receiver) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver8get_mesgEP7OSCMesg"]
        pub fn OSC_Receiver_get_mesg(
            this: *mut root::OSC_Receiver,
            bucket: *mut root::OSCMesg,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver11add_addressEP17OSC_Address_Space"]
        pub fn OSC_Receiver_add_address(
            this: *mut root::OSC_Receiver,
            o: *mut root::OSC_Address_Space,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver14remove_addressEP17OSC_Address_Space"]
        pub fn OSC_Receiver_remove_address(
            this: *mut root::OSC_Receiver,
            o: *mut root::OSC_Address_Space,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver9new_eventEPc"]
        pub fn OSC_Receiver_new_event(
            this: *mut root::OSC_Receiver,
            spec: *mut ::std::os::raw::c_char,
        ) -> *mut root::OSC_Address_Space;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver9new_eventEPcS0_"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver18distribute_messageEP7OSCMesg"]
        pub fn OSC_Receiver_distribute_message(
            this: *mut root::OSC_Receiver,
            msg: *mut root::OSCMesg,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_ReceiverC1EP8Chuck_VM"]
        pub fn OSC_Receiver_OSC_Receiver(this: *mut root::OSC_Receiver, vm: *mut root::Chuck_VM);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_ReceiverC1EP8Chuck_VMP12UDP_Receiver"]
        pub fn OSC_Receiver_OSC_Receiver1(
            this: *mut root::OSC_Receiver,
            vm: *mut root::Chuck_VM,
            in_: *mut root::UDP_Receiver,
        );
    }
    impl OSC_Receiver {
        #[inline]
        ...
        #[inline]
        pub unsafe fn bind_to_port(&mut self, port: ::std::os::raw::c_int) {
        ...
        #[inline]
        pub unsafe fn listen(&mut self, port: ::std::os::raw::c_int) -> bool {
        ...
        #[inline]
        pub unsafe fn next_read(&mut self) -> *mut root::OSCMesg {
        ...
        #[inline]
        pub unsafe fn get_mesg(&mut self, bucket: *mut root::OSCMesg) -> bool {
            OSC_Receiver_get_mesg(self, bucket)
        }
        #[inline]
        pub unsafe fn add_address(&mut self, o: *mut root::OSC_Address_Space) {
            OSC_Receiver_add_address(self, o)
        }
        #[inline]
        pub unsafe fn remove_address(&mut self, o: *mut root::OSC_Address_Space) {
            OSC_Receiver_remove_address(self, o)
        }
        #[inline]
        pub unsafe fn new_event(
            &mut self,
            spec: *mut ::std::os::raw::c_char,
        ) -> *mut root::OSC_Address_Space {
        ...
        #[inline]
        pub unsafe fn distribute_message(&mut self, msg: *mut root::OSCMesg) {
        ...
        #[inline]
        pub unsafe fn new1(vm: *mut root::Chuck_VM, in_: *mut root::UDP_Receiver) -> Self {
            let mut __bindgen_tmp = ::std::mem::uninitialized();
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver9onReceiveEPci"]
        pub fn OSC_Receiver_onReceive(
            this: *mut ::std::os::raw::c_void,
            mesg: *mut ::std::os::raw::c_char,
            mesgLen: ::std::os::raw::c_int,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_Receiver4portEv"]
        pub fn OSC_Receiver_port(this: *mut ::std::os::raw::c_void) -> *mut ::std::os::raw::c_int;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12OSC_ReceiverD1Ev"]
        pub fn OSC_Receiver_OSC_Receiver_destructor(this: *mut root::OSC_Receiver);
    }
    pub const osc_datatype_OSC_UNTYPED: root::osc_datatype = 0;
    pub const osc_datatype_OSC_NOARGS: root::osc_datatype = 1;
    pub const osc_datatype_OSC_INT: root::osc_datatype = 2;
    pub const osc_datatype_OSC_FLOAT: root::osc_datatype = 3;
    pub const osc_datatype_OSC_STRING: root::osc_datatype = 4;
    pub const osc_datatype_OSC_BLOB: root::osc_datatype = 5;
    pub const osc_datatype_OSC_NTYPE: root::osc_datatype = 6;
    pub type osc_datatype = u32;
    #[repr(C)]
    pub struct opsc_data {
        pub t: root::osc_datatype,
        pub timetag: root::OSCTimeTag,
        pub __bindgen_anon_1: root::opsc_data__bindgen_ty_1,
    ...
    pub union opsc_data__bindgen_ty_1 {
        pub i: root::int4byte,
        pub u: ::std::os::raw::c_ulong,
        pub f: f32,
        _bindgen_union_align: u64,
    }
    pub type OSCSrc = root::OSC_Address_Space;
    #[repr(C)]
    pub struct OSC_Address_Space {
        pub _base: root::Chuck_Event,
        pub _receiver: *mut root::OSC_Receiver,
        pub _buffer_mutex: *mut root::XMutex,
        pub _spec: [::std::os::raw::c_char; 512usize],
        pub _needparse: bool,
        pub _address: [::std::os::raw::c_char; 512usize],
        pub _type: [::std::os::raw::c_char; 512usize],
        pub _queue: *mut root::opsc_data,
        pub _current_data: *mut root::opsc_data,
        pub _qread: ::std::os::raw::c_int,
        pub _qwrite: ::std::os::raw::c_int,
        pub _queueSize: ::std::os::raw::c_int,
        pub _cur_value: ::std::os::raw::c_int,
        pub _cur_mesg: *mut root::opsc_data,
        pub _vals: *mut root::opsc_data,
        pub _dataSize: ::std::os::raw::c_int,
        pub _noArgs: bool,
        pub SELF: *mut root::Chuck_Object,
        pub p_str: root::Chuck_String,
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space10resizeDataEi"]
        pub fn OSC_Address_Space_resizeData(
            this: *mut root::OSC_Address_Space,
            n: ::std::os::raw::c_int,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space11resizeQueueEi"]
        pub fn OSC_Address_Space_resizeQueue(
            this: *mut root::OSC_Address_Space,
            n: ::std::os::raw::c_int,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space9parseSpecEv"]
        pub fn OSC_Address_Space_parseSpec(this: *mut root::OSC_Address_Space);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space8scanSpecEv"]
        pub fn OSC_Address_Space_scanSpec(this: *mut root::OSC_Address_Space);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space4initEv"]
        pub fn OSC_Address_Space_init(this: *mut root::OSC_Address_Space);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space7setSpecEPKc"]
        pub fn OSC_Address_Space_setSpec(
            this: *mut root::OSC_Address_Space,
            c: *const ::std::os::raw::c_char,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space7setSpecEPKcS1_"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space11setReceiverEP12OSC_Receiver"]
        pub fn OSC_Address_Space_setReceiver(
            this: *mut root::OSC_Address_Space,
            recv: *mut root::OSC_Receiver,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space14try_queue_mesgEP7OSCMesg"]
        pub fn OSC_Address_Space_try_queue_mesg(
            this: *mut root::OSC_Address_Space,
            o: *mut root::OSCMesg,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space15message_matchesEP7OSCMesg"]
        pub fn OSC_Address_Space_message_matches(
            this: *mut root::OSC_Address_Space,
            o: *mut root::OSCMesg,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space10queue_mesgEP7OSCMesg"]
        pub fn OSC_Address_Space_queue_mesg(
            this: *mut root::OSC_Address_Space,
            o: *mut root::OSCMesg,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space8has_mesgEv"]
        pub fn OSC_Address_Space_has_mesg(this: *mut root::OSC_Address_Space) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space9next_mesgEv"]
        pub fn OSC_Address_Space_next_mesg(this: *mut root::OSC_Address_Space) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space4waitEP14Chuck_VM_ShredP8Chuck_VM"]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space6vcheckE12osc_datatype"]
        pub fn OSC_Address_Space_vcheck(
            this: *mut root::OSC_Address_Space,
            tt: root::osc_datatype,
        ) -> bool;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space8next_intEv"]
        pub fn OSC_Address_Space_next_int(this: *mut root::OSC_Address_Space) -> root::int4byte;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space10next_floatEv"]
        pub fn OSC_Address_Space_next_float(this: *mut root::OSC_Address_Space) -> f32;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space11next_stringEv"]
        pub fn OSC_Address_Space_next_string(
            this: *mut root::OSC_Address_Space,
        ) -> *mut ::std::os::raw::c_char;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space15next_string_dupEv"]
        pub fn OSC_Address_Space_next_string_dup(
            this: *mut root::OSC_Address_Space,
        ) -> *mut ::std::os::raw::c_char;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_Space9next_blobEv"]
        pub fn OSC_Address_Space_next_blob(
            this: *mut root::OSC_Address_Space,
        ) -> *mut ::std::os::raw::c_char;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_SpaceC1Ev"]
        pub fn OSC_Address_Space_OSC_Address_Space(this: *mut root::OSC_Address_Space);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_SpaceC1EPKc"]
        pub fn OSC_Address_Space_OSC_Address_Space1(
            this: *mut root::OSC_Address_Space,
            spec: *const ::std::os::raw::c_char,
        );
    }
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_SpaceC1EPKcS1_"]
    ...
    impl OSC_Address_Space {
        #[inline]
        pub unsafe fn resizeData(&mut self, n: ::std::os::raw::c_int) {
            OSC_Address_Space_resizeData(self, n)
        }
        #[inline]
        pub unsafe fn resizeQueue(&mut self, n: ::std::os::raw::c_int) {
        ...
        #[inline]
        pub unsafe fn setSpec(&mut self, c: *const ::std::os::raw::c_char) {
            OSC_Address_Space_setSpec(self, c)
        }
        #[inline]
        pub unsafe fn setSpec1(
            &mut self,
            addr: *const ::std::os::raw::c_char,
            type_: *const ::std::os::raw::c_char,
        ) {
        ...
        #[inline]
        pub unsafe fn setReceiver(&mut self, recv: *mut root::OSC_Receiver) {
            OSC_Address_Space_setReceiver(self, recv)
        }
        #[inline]
        pub unsafe fn try_queue_mesg(&mut self, o: *mut root::OSCMesg) -> bool {
            OSC_Address_Space_try_queue_mesg(self, o)
        }
        #[inline]
        pub unsafe fn message_matches(&mut self, o: *mut root::OSCMesg) -> bool {
            OSC_Address_Space_message_matches(self, o)
        }
        #[inline]
        pub unsafe fn queue_mesg(&mut self, o: *mut root::OSCMesg) {
        ...
        #[inline]
        pub unsafe fn vcheck(&mut self, tt: root::osc_datatype) -> bool {
            OSC_Address_Space_vcheck(self, tt)
        }
        #[inline]
        pub unsafe fn next_int(&mut self) -> root::int4byte {
        ...
        #[inline]
        pub unsafe fn next_string(&mut self) -> *mut ::std::os::raw::c_char {
            OSC_Address_Space_next_string(self)
        }
        #[inline]
        pub unsafe fn next_string_dup(&mut self) -> *mut ::std::os::raw::c_char {
            OSC_Address_Space_next_string_dup(self)
        }
        #[inline]
        pub unsafe fn next_blob(&mut self) -> *mut ::std::os::raw::c_char {
        ...
        #[inline]
        pub unsafe fn new1(spec: *const ::std::os::raw::c_char) -> Self {
            let mut __bindgen_tmp = ::std::mem::uninitialized();
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN17OSC_Address_SpaceD1Ev"]
        pub fn OSC_Address_Space_OSC_Address_Space_destructor(this: *mut root::OSC_Address_Space);
    }
