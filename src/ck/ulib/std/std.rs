...
pub mod root {
    ...
    extern "C" {
        pub fn libstd_query(QUERY: *mut root::Chuck_DL_Query) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        pub fn abs_impl(
            ARGS: *mut ::std::os::raw::c_void,
    ...
    pub struct KBHit {
        ...
        pub m_onoff: ::std::os::raw::c_ulong,
        pub m_echo: ::std::os::raw::c_ulong,
        pub SELF: *mut root::Chuck_Object,
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit4openEv"]
        pub fn KBHit_open(this: *mut root::KBHit) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit5closeEv"]
        pub fn KBHit_close(this: *mut root::KBHit) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit2onEv"]
        pub fn KBHit_on(this: *mut root::KBHit);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit3offEv"]
        pub fn KBHit_off(this: *mut root::KBHit);
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit5emptyEv"]
        pub fn KBHit_empty(this: *mut root::KBHit) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHit5getchEv"]
        pub fn KBHit_getch(this: *mut root::KBHit) -> ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHitC1Ev"]
        pub fn KBHit_KBHit(this: *mut root::KBHit);
    }
    impl KBHit {
        #[inline]
        pub unsafe fn open(&mut self) -> ::std::os::raw::c_ulong {
            KBHit_open(self)
        }
        #[inline]
        ...
        #[inline]
        pub unsafe fn getch(&mut self) -> ::std::os::raw::c_long {
            KBHit_getch(self)
        }
        #[inline]
        pub unsafe fn new() -> Self {
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN5KBHitD1Ev"]
        pub fn KBHit_KBHit_destructor(this: *mut root::KBHit);
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager7the_bufE"]
        pub static mut KBHitManager_the_buf: *mut root::CBufferAdvance;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager9the_onoffE"]
        pub static mut KBHitManager_the_onoff: ::std::os::raw::c_long;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager8the_initE"]
        pub static mut KBHitManager_the_init: ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager10the_threadE"]
        pub static mut KBHitManager_the_thread: *mut root::XThread;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager4initEv"]
        pub fn KBHitManager_init() -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager8shutdownEv"]
        pub fn KBHitManager_shutdown();
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager2onEv"]
        pub fn KBHitManager_on();
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager3offEv"]
        pub fn KBHitManager_off();
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager4openEP5KBHit"]
        pub fn KBHitManager_open(kb: *mut root::KBHit) -> ::std::os::raw::c_ulong;
    }
    extern "C" {
        #[link_name = "\u{1}_ZN12KBHitManager5closeEP5KBHit"]
        pub fn KBHitManager_close(kb: *mut root::KBHit) -> ::std::os::raw::c_ulong;
    }
    impl KBHitManager {
        #[inline]
        pub unsafe fn init() -> ::std::os::raw::c_ulong {
            KBHitManager_init()
        }
        #[inline]
        ...
        #[inline]
        pub unsafe fn open(kb: *mut root::KBHit) -> ::std::os::raw::c_ulong {
            KBHitManager_open(kb)
        }
        #[inline]
        pub unsafe fn close(kb: *mut root::KBHit) -> ::std::os::raw::c_ulong {
