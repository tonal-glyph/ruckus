...
//-----------------------------------------------------------------------------
struct Chuck_Instr {
    pub m_linepos: t_CKUINT,
}
impl Chuck_Instr {
    pub fn new() { Chuck_Instr; }
    pub fn destroy(this: &Self) { drop(this); }
    pub fn execute(vm: *mut Chuck_VM, shred: *mut Chuck_VM_Shred) {
        0
    }
    // pub fn name(const c_char) { b"\0"; }
    // pub fn params(const c_char) { b"\0"; }
    pub fn set_linepos(linepos: t_CKUINT) {}
}
...
// desc: ...
//-----------------------------------------------------------------------------
struct Chuck_Instr_Branch_Op {
    m_jmp: t_CKUINT,
}
impl Chuck_Instr for Chuck_Instr_Branch_Op {
    pub fn set(jmp: t_CKUINT) { m_jmp = jmp; }
    // pub fn params(*const c_char) {
