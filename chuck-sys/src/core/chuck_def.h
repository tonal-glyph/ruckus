...
// types
#define t_CKTIME                    double // Rust f64
#define t_CKDUR                     double // Rust f64
#define t_CKFLOAT                   double // Rust f64
#define t_CKDOUBLE                  double // Rust f64
#define t_CKSINGLE                  float // Rust f32
#ifdef _WIN64                       // REFACTOR-2017
#define t_CKINT                     long long // REFACTOR-2017 // Rust i64
#else
#define t_CKINT                     long // Rust i32
#endif
#define t_CKUINT                    unsigned t_CKINT // Rust u64
#define t_CKBOOL                    unsigned t_CKINT // Rust u64
#define t_CKBYTE                    unsigned char // Rust u8
#define t_CKVOID                    void // Rust c_void
#define t_CKVOIDPTR                 void * // Rust *mut c_void

// complex type
typedef struct { t_CKFLOAT re ; t_CKFLOAT im ; } t_CKCOMPLEX; // Rust f64
// polar type
typedef struct { t_CKFLOAT modulus ; t_CKFLOAT phase ; } t_CKPOLAR; // Rust f64

// vector types
typedef struct { t_CKFLOAT x ; t_CKFLOAT y ; t_CKFLOAT z ; } t_CKVEC3; // Rust f64
typedef struct { t_CKFLOAT x ; t_CKFLOAT y ; t_CKFLOAT z ; t_CKFLOAT w ; } t_CKVEC4; // Rust f64
typedef struct { t_CKUINT N ; t_CKFLOAT * values ; } t_CKVECTOR; // u64, f64
...
#define SAMPLE                      double  // Rust f64
#define SILENCE                     0.0  // Rust f64
#define CK_DDN                      CK_DDN_DOUBLE
#else
#define SAMPLE                      float  // Rust f64
#define SILENCE                     0.0f  // Rust f64
...
// sample complex
typedef struct { SAMPLE re ; SAMPLE im ; } t_CKCOMPLEX_SAMPLE; // Rust f64
